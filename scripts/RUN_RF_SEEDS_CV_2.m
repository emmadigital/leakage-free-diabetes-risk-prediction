...
for s = 1:S
    ...
    y_all = [];
    p_all = [];
    id_all = [];   % initialize once per seed
    fold_auc = zeros(K,1);
    ...
    for k = 1:K
        ...
        % Robust extraction of class-1 probabilities
...
fprintf('\n=== Random Forest - Dataset 2 (%d seeds, %d-fold CV) ===\n', S, K);
